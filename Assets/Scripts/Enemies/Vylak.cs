...
public class Vylak : MonoBehaviour
{
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            ...
            GameObject bulletObject = Instantiate(enemyBullet, spawnPoint.transform.position, spawnPoint.transform.rotation) as GameObject; // spawns the bullet
